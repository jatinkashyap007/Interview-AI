...
const QuestionCard = ({ item, index, jobDescription }) => {
    ...
    const onGradeSubmit = async (e) => {
        ...
        setIsGrading(true)
        setEvalError("")
        toast.loading("Evaluating your answer...", { id: "eval-answer" })
        ...
        setIsGrading(false)
        if (res.success) {
            toast.success("Answer evaluated!", { id: "eval-answer" })
            setEvaluation(res.evaluation)
        } else {
            toast.error(res.error, { id: "eval-answer" })
...
const Interview = () => {
    ...
    const handleDownloadPdf = async () => {
        toast.loading("Generating your customized Resume PDF...", { id: "download-pdf" })
        try {
            await getResumePdf(interviewId)
            toast.success("Resume PDF downloaded!", { id: "download-pdf" })
        } catch (err) {
