                ...
                <div className='interview-card__body'>
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label
                                className={`dropzone ${isDragging ? 'dropzone--dragging' : ''} ${selectedFile ? 'dropzone--active' : ''}`}
                                htmlFor='resume'
                            ...
                            >
                                {selectedFile ? (
                                    <div className='dropzone__uploaded'>
                                        ...
                                        <button type='button' onClick={handleRemoveFile} className='dropzone__remove-btn' title='Remove file'>
                                            &times;
                                        </button>
                                    </div>
                                ) : (
